...
export const getInfoUser = state => selectorsAuth.getInfoUser(state.auth);
export const getOrders = state => selectorsAuth.getOrders(state.auth);
export const getSelectOrder = state => selectorsAuth.getSelectOrder(state.auth);
export const getUserOrders = state => selectorsAuth.getUserOrders(state.auth);
export const getPassword = state => selectorsAuth.getPassword(state.auth);
